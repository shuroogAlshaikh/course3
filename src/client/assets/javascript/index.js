...
// same logic as getTracks() BUT with async/await 
...
function startRace(id) {
	let startRaceFun = fetch(`${SERVER}/api/races/${id}/start`, {
		method: 'POST',
		...defaultFetchOpts(),
	})
	.then(res => res.json())
